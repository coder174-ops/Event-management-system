...
const FailedTask = ({data}) => {
  return (
    <div className='flex-shrink-0 h-full w-[320px] bg-red-400  items-start justify-start rounded-2xl'>
...
taskDescription
    ...
    <div className='flex items-center justify-center mt-4'>
      <button className='bg-red-800 px-2  py-1 rounded text-white text-lg hover:cursor-pointer hover:bg-red-950'>FailedTask</button>
    </div>
   </div>
  )
}
